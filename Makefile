...
run1:
	./p1 two_objects.pgm 139 temp_results/output_p1_two_objects.pgm;
...
run2:
	./p2 temp_results/output_p1_two_objects.pgm temp_results/output_p2_two_objects.pgm
	...
	open temp_results/output_p2_two_objects.pgm;
